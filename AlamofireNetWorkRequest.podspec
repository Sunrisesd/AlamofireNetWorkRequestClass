Pod::Spec.new do |s| 
  s.name         = "AlamofireNetWorkRequest"			#SDK名称
  s.version      = "1.0.2"                        		#版本号
  s.homepage     = "https://github.com/Sunrisesd"  		#工程主页地址
  s.summary      = "基于Alamofire库的网络请求类"  			#项目的简单描述
  s.license  	 = "MIT"  					#协议类型
  ...
  s.source       = { :git => "https://github.com/Sunrisesd/AlamofireNetWorkRequestClass.git" ,:tag => "#{s.version}"}   	#工程地址及版本号
  s.requires_arc = true   					#是否必须arc
  s.source_files = "AlamofireNetWorkRequest.swift"   		#SDK实际的重要文件路径
